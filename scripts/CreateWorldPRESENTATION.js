...
function Step3(){
	...
	alert("Model is Loaded");
		...
		document.getElementById("HouseLayerName").value="House point";
		document.getElementById("HouseLayerOrientation").value = 300;
	 ...
	 e.options[e.selectedIndex].value = "Point Layer House model";
		AddHouse();
...
function Step4(){
	...
	alert("Model is Loaded");
		...
		document.getElementById("PlantLayerName").value="Palm_arecaceae line";
	 ...
	 e.options[e.selectedIndex].value = "Line Layer Tree model";
		AddTrees(TreeModelTable,TreeModel);	
}
...
function Step5(){
	...
	alert("Model is Loaded");
		...
		document.getElementById("PlantLayerName").value="Flamboyant polygon";
		...
		document.getElementById("PlantPos_polygon_properties_intervalX").value = 5;
		document.getElementById("PlantPos_polygon_properties_intervalY").value = 5;
		
		var e = document.getElementById("PlantPositionType_selectmenu_polygon");
	 e.options[e.selectedIndex].value = "Polygon Layer Tree model";
		AddTrees(TreeModelTable,TreeModel);	
}
function Step6(){
					var e = document.getElementById("GroundPositionType_selectmenu_polygon");
					document.getElementById("WaterLayerName").value = "Water Polygon";
					document.getElementById("WaterLayerZposition").value =0;
					
e.options[e.selectedIndex].value = "Polygon Layer Water Material";
AddWater();			

e.options[e.selectedIndex].value = "Polygon Layer Water Clear";
document.getElementById("WaterLayerName").value = "Water Polygon CLEAR";
document.getElementById("WaterLayerZposition").value =0;
AddWater();
...
function Step7(){
					...
					document.getElementById("AnimalLayerName").value = "Animal animation line";
					var e= document.getElementById("AnimalPositionType_selectmenu_line");
					
e.options[e.selectedIndex].value = "Animal Line Layer";
...
function Step8(){
					...
					document.getElementById("CarLayerName").value = "Car animation line 1";
					var e= document.getElementById("OtherPositionType_selectmenu_line");
					
e.options[e.selectedIndex].value = "Car Line Layer";
